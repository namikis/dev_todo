...
- [概要 (Overview)](https://docs.anthropic.com/en/docs/claude-code/overview)
...
- [設定 (Settings)](https://docs.anthropic.com/en/docs/claude-code/settings)
- [フック (Hooks)](https://docs.anthropic.com/en/docs/claude-code/hooks)
- [MCP](https://docs.anthropic.com/en/docs/claude-code/mcp)
- [メモリ (Memory)](https://docs.anthropic.com/en/docs/claude-code/memory)
...
Describe what you want in plain language. Claude Code plans the approach, writes the code across multiple files, and verifies it works.For bugs, paste an error message or describe the symptom. Claude Code traces the issue through your codebase, identifies the root 
...
See [managed settings](https://docs.anthropic.com/docs/en/permissions#managed-only-settings) and [Managed MCP configuration](https://docs.anthropic.com
...
Hooks are defined in JSON settings file
...
**Structure**: use markdown headers and bullets to group related instructions. Claude scans structure the same way readers do: organized sections are easier to follow than den
